...
public class LinkedList<T> implements List<T> {
    ...
    /**
     * Merges lists into a new one, appends {@param list} to this list
     * @param list list to merge with this list
     * @return list of merge result
     */
    public LinkedList<T> merge(LinkedList<T> list) {
        LinkedList<T> result = this;
        result.tail.next = list.head.next;
